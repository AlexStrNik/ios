...
let favoriteBook = Book(title: "Test", author: "Test", pages: 90, price: 34.5)
print("My favorite book is \(favoriteBook.title) written by \(favoriteBook.author) costs \(favoriteBook.price)$ and consists of \(favoriteBook.pages) pages")
...
var air = Laptop(yearPurchased: 2015)
var m1pro = Laptop(screenSize: 16, yearPurchased: 2021)
/*:
...
let myHeight = Height(centimeters: 160)
